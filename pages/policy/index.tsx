...
const PrivacyPolicy = () => (
  <LayoutLanding home={false} title="Moonstream: Privacy policy">
    <Box mt="72px">
      <Box m="auto" mb={8} maxWidth="1238px" minHeight="60vh">
        ...
        <Text fontSize="md">
          At Moonstream, accessible from https://moonstream.to/, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by Moonstream and how we use it. If you have additional
          ...
          our website with regards to the information that they shared and/or collect in Moonstream.
          This policy is not applicable to any information collected offline or via channels other
          than this website. Consent By using our website, you hereby consent to our Privacy Policy
          and agree to its terms. Information we collect The personal information that you are asked
          to provide, and the reasons why you are asked to provide it, will be made clear to you at
          ...
          any other information you may choose to provide. When you register for an Account, we may
        ...
        <Text mt={4} fontSize="md">
          ...
          <li>
            Communicate with you directly, including for customer service, to provide you with
            updates and other information relating to the webste, and for marketing and promotional
            purposes
          </li>
        ...
        <Text mt={4} fontSize="md">
          ...
          request copies of your personal data. We may charge you a small fee for this service. The
          ...
          you believe is incomplete. The right to erasure – You have the right to request that we
          erase your personal data, under certain conditions. The right to restrict processing – You
          have the right to request that we restrict the processing of your personal data, under
          certain conditions. The right to object to processing – You have the right to object to
          our processing of your personal data, under certain conditions. The right to data
          portability – You have the right to request that we transfer the data that we have
          collected to another organization, or directly to you, under certain conditions. If you
        ...
        <Text mt={4} fontSize="md">
          ...
          their online activity. Moonstream does not knowingly collect any Personal Identifiable
