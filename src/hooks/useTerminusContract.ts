...
import {
  ...
  balanceOfAddress,
} from '../web3/contracts/terminus.contracts'
import { getTokenState } from '../web3/contracts/erc20.contracts'
...
export const useTerminusContract = ({
  ...
  const commonProps = {
    onSuccess: () => {
      toast({ description: 'Successfully updated contract', status: 'success' })
