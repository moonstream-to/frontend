...
export interface MockTerminus extends BaseContract {
  ...
  methods: {
    ...
    terminusPoolCapacity(poolID: number | string | BN): NonPayableTransactionObject<string>

    terminusPoolController(poolID: number | string | BN): NonPayableTransactionObject<string>

    terminusPoolSupply(poolID: number | string | BN): NonPayableTransactionObject<string>
  ...
  events: {
    ...
    PoolMintBatch(options?: EventOptions, cb?: Callback<PoolMintBatch>): EventEmitter
