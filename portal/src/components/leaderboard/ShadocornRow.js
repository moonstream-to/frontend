...
import { SHADOWCORN_CONTRACT_ADDRESS } from "../../constants";
...
const ShadowcornRow = ({ shadowcorn, tokenId }) => {
  return (
    <Link p="0px" _hover={{ bgColor: "#454545" }} href={buildOpenseaLink(tokenId)} isExternal>
      <Flex alignItems="center">
        ...
        <Icon as={FiExternalLink} marginInlineStart="2px" my="auto" pb={["4px", "4px", "2px"]} />
      </Flex>
    </Link>
  );
};
