  ...
  return (
    <Accordion bgColor="#232323" rounded="lg" allowToggle>
      <AccordionItem borderWidth={0} borderBottomWidth="0!important">
        ...
        <AccordionPanel pb={4}>
          <Flex ml="20px">
            <Box maxH="235px" overflow="scroll">
              <APIMethod
                id={id}
              ...
              <APIMethod
                ...
                methodDescription={
                  "Return positions of leaderboard on edges of 25%, 50%, 75% percentile."
                }
                parameterList={[
                  {
                    name: "leaderboard_id",
              ...
              <APIMethod
                ...
                methodDescription={
                  "Return information about ranks bucket(size, score) in leaderboars."
                }
                parameterList={[
                  {
                    name: "leaderboard_id",
